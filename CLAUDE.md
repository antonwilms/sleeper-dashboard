...
| `portfolio/Portfolio.jsx` | New primary surface from the Dynasty Portfolio redesign (1b). Routed at `/portfolio`; placeholder-only as of Slice i (content lands in Slice iv). Dark-only `--color-dp-*` content tokens |
