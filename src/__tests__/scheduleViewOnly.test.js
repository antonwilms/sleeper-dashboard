...
describe('schedule stays view-only', () => {
  for (const f of PIPELINE) {
    it(`${f} does not import nflSchedule / loadNflSchedule`, () => {
  ...
  it('nflSchedule.js imports nothing from projection/scoring', () => {
    const src = readFileSync('src/api/nflSchedule.js', 'utf8')
